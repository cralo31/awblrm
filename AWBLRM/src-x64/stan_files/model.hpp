...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(20, 20, "end", "model_model");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            current_statement_begin__ = 5;
            for (int k0__ = 0; k0__ < N; ++k0__) {
                check_greater_or_equal(function__,"W[k0__]",W[k0__],0);
                check_less_or_equal(function__,"W[k0__]",W[k0__],1);
            }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                lp_accum__.add(bernoulli_log<propto__>(get_base1(y,n,"y",1), (get_base1(W,n,"W",1) * (exp(((beta * get_base1(dose,n,"dose",1)) + alpha)) / (1 + exp(((beta * get_base1(dose,n,"dose",1)) + alpha)))))));
            }
